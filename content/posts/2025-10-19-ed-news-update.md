...
I also decided to share the item database through Parquet files so that the publication data is explorable. Parquet's columnar format pairs well with DuckDB's query engine, making remote queries fast and efficient. The two main databases are:
